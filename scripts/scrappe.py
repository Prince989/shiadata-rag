...
if __name__ == "__main__":
    ...
    # scrapeWithoutPTag("bihar-al-anvar", "bihar-al-anvar", "https://lib.eshia.ir/11008", 32, 1, 620)
    # scrapeWithoutPTag("bihar-al-anvar", "bihar-al-anvar", "https://lib.eshia.ir/11008", 33, 1, 641)
    # scrapeWithoutPTag("bihar-al-anvar", "bihar-al-anvar", "https://lib.eshia.ir/11008", 34, 1, 454)
    ...
    scrape('tafsir', 'al-ayashi', 'https://lib.eshia.ir/12013', 1, 1, 404)
    scrape('tafsir', 'al-ayashi', 'https://lib.eshia.ir/12013', 2, 1, 369)

    scrape('tafsir', 'al-borhan', 'https://lib.eshia.ir/71664', 1, 1, 753)
    scrape('tafsir', 'al-borhan', 'https://lib.eshia.ir/71664', 2, 1, 898)
    scrape('tafsir', 'al-borhan', 'https://lib.eshia.ir/71664', 3, 1, 932)
    scrape('tafsir', 'al-borhan', 'https://lib.eshia.ir/71664', 4, 1, 908)
    scrape('tafsir', 'al-borhan', 'https://lib.eshia.ir/71664', 5, 1, 913)

    scrape('tafsir', 'noor-al-thaqalayn', 'https://lib.eshia.ir/12024', 1, 1, 805)
    scrape('tafsir', 'noor-al-thaqalayn', 'https://lib.eshia.ir/12024', 2, 1, 572)
    scrape('tafsir', 'noor-al-thaqalayn', 'https://lib.eshia.ir/12024', 3, 1, 643)
    scrape('tafsir', 'noor-al-thaqalayn', 'https://lib.eshia.ir/12024', 4, 1, 653)
    scrape('tafsir', 'noor-al-thaqalayn', 'https://lib.eshia.ir/12024', 5, 1, 749)

    scrape('tafsir', 'al-forat', 'https://lib.eshia.ir/27170', 1, 1, 721)

    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 1, 1, 487)
    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 2, 1, 920)
    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 3, 1, 419)
    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 4, 1, 866)
    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 5, 1, 417)
    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 6, 1, 824)
    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 7, 1, 423)
    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 8, 1, 833)
    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 9, 1, 425)
    scrape('tafsir', 'majma-al-bayan', 'https://lib.eshia.ir/86854', 10, 1, 871)

    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 1, 1, 671)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 2, 1, 689)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 3, 1, 601)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 4, 1, 678)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 5, 1, 659)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 6, 1, 541)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 7, 1, 548)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 8, 1, 506)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 9, 1, 566)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 10, 1, 575)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 11, 1, 534)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 12, 1, 543)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 13, 1, 560)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 14, 1, 587)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 15, 1, 585)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 16, 1, 594)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 17, 1, 617)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 18, 1, 588)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 19, 1, 678)
    scrape('tafsir', 'al-mizan', 'https://lib.eshia.ir/50081', 20, 1, 693)

    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 1, 1, 841)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 2, 1, 859)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 3, 1, 592)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 4, 1, 572)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 5, 1, 567)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 6, 1, 517)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 7, 1, 537)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 8, 1, 487)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 9, 1, 517)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 10, 1, 439)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 11, 1, 504)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 12, 1, 626)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 13, 1, 578)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 14, 1, 607)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 15, 1, 611)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 16, 1, 516)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 17, 1, 488)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 18, 1, 593)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 19, 1, 585)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 20, 1, 538)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 21, 1, 518)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 22, 1, 587)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 23, 1, 638)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 24, 1, 556)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 25, 1, 485)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 26, 1, 553)
    scrape('tafsir', 'nemune', 'https://lib.eshia.ir/27575', 27, 1, 584)

    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 1, 1, 493)
    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 2, 1, 604)
    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 3, 1, 617)
    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 4, 1, 561)
    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 5, 1, 500)
    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 6, 1, 536)
    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 7, 1, 515)
    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 8, 1, 587)
    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 9, 1, 599)
    scrape('tafsir', 'tebyan', 'https://lib.eshia.ir/86469', 10, 1, 439)